...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="black" data-background-color="black" >
      ...
      <div class="logo"><a href="../Home.php" class="simple-text logo-normal"><img src="logo.png" width="130" height="130"><br>
          RAISE MY VOICE
        </a></div>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
					<div class="container-fluid">
						<div class="navbar-wrapper">
							<h3>Administrator</h3><h5>Dashboard</h5>
						</div>
					</div>
				</nav>
      <!-- End Navbar -->
